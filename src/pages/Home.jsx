  ...
  return (
    <div style={{ height: "100vh", padding: "20px", backgroundColor: "#232323", color: "white" }}>
      ...
      <ul style={{ listStyle: "none", padding: "0" }}>
        ...
        <li style={{ marginBottom: "10px" }}>
          <Link to="/dashboardhome" style={{ color: "#87CEFA", textDecoration: "none" }}>
            DashboardHome
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <Link to="/allproducts" style={{ color: "#87CEFA", textDecoration: "none" }}>
            Allproducts
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <Link to="/orderslist" style={{ color: "#87CEFA", textDecoration: "none" }}>
            Orderslist
          </Link>
        </li>
      </ul>
